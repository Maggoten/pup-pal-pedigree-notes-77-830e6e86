...
const eventTypeColors = {
  ...
  'heat-active': 'bg-rose-300 text-rose-900 border-rose-400',
  'ovulation-predicted': 'bg-purple-200 text-purple-900 border-purple-400 shadow-purple-200/50 shadow-lg',
  'fertility-window': 'bg-violet-150 text-violet-900 border-violet-350 shadow-violet-200/40 shadow-md',
  'mating': 'bg-violet-100 text-violet-800 border-violet-300 font-semibold',
  'due-date': 'bg-warmgreen-100 text-warmgreen-800 border-warmgreen-300 font-semibold',
