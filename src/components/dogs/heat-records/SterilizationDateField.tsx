...
const SterilizationDateField: React.FC<SterilizationDateFieldProps> = ({
  ...
  const handleAddDate = () => {
    ...
    form.setValue('sterilizationDate', newDate, { shouldValidate: true, shouldDirty: true });
  };

  const handleRemoveDate = () => {
    form.setValue('sterilizationDate', undefined, { shouldValidate: true, shouldDirty: true });
  };
