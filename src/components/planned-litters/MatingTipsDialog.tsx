...
interface MatingTipsDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const MatingTipsDialog: React.FC<MatingTipsDialogProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{t('matingTips.title')}</DialogTitle>
          <DialogDescription>{t('matingTips.description')}</DialogDescription>
        </DialogHeader>
...
export default MatingTipsDialog;
