...
const PregnancySummaryCards: React.FC<PregnancySummaryCardsProps> = ({
  ...
  return (
    <Card className="mb-6 greige-gradient border border-greige-300 overflow-hidden relative">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 opacity-10">
        <PawPrint className="w-32 h-32 text-greige-700 transform rotate-12" />
      </div>
      <div className="absolute bottom-0 left-0 opacity-10">
        <PawPrint className="w-20 h-20 text-greige-700 transform -rotate-12" />
      </div>
      ...
      <CardContent className="pt-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-greige-50 border border-greige-200 rounded-lg p-4 flex flex-col items-center transform transition-transform hover:scale-105 hover:shadow-md">
            ...
            <div className="w-full bg-greige-100 h-2 rounded-full mt-2 overflow-hidden">
              <div 
                className="bg-greige-500 h-full rounded-full"
